...
/* =========================================================
   KARANGAN AI v3.9
   FORCE COMPLETE TRANSLATION
   ========================================================= */

(() => {
  "use strict";

  const oldTranslateWordV39 =
    translateWord;

  async function fetchCompleteTranslationV39(
    word,
    sentence,
    localChinese = ""
  ) {
  ...
  translateWord =
    async function(rawWord) {
      ...
      try {
        ...
        const complete =
          await fetchCompleteTranslationV39(
            word,
            sentence,
            localChinese
          );
        ...
        console.warn(
          "v3.9 complete translation failed:",
          word,
          error
        );

        /*
          Do NOT fall back to Chinese-only result.
        */
  ...
  console.log(
    "✅ Karangan AI v3.9 Force Complete Translation loaded"
  );
