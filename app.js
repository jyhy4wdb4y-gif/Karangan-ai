...
(function(){
  ...
  function l3Feedback(result,praise,feedback,success,guided){
    ...
    openModuleScreen(`<div style="display:flex;align-items:center;justify-content:space-between;gap:8px;padding:8px 10px;border-radius:14px;background:#f7f7f7;margin-bottom:10px">
      ...
      ${success&&!guided?`<button id="l3Next" class="primary-button" style="width:100%;margin-top:14px">Teruskan →</button>`:`<button id="l3Retry" class="primary-button" style="width:100%;margin-top:14px">${l3Level()==="ASAS"?"✓ Saya Sudah Faham":"✍️ Cuba Bina Ayat Sendiri"}</button>`}`,42);
  }
