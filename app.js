...
(function(){
  ...
  function l3Feedback(result,praise,feedback,success,guided){
    ...
    openModuleScreen(`<div style="padding:12px;border-radius:16px;background:#f7f7f7;margin-bottom:12px">
  ...
  function l3ThemeAction(e){
    const el=e.target.closest?.("[data-l3-theme],#l3ThemeContinue,#l3ThemeDone"); if(!el)return;
